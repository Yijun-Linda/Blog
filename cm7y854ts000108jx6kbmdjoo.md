...
1. **项目经历** —— 这个人有没有真正做过强化学习的相关项目？
    
2. **代码质量** —— 代码是否开源？有无实际贡献？写的代码能不能跑起来？
    
3. **过往贡献** —— 是否在强化学习领域有论文、比赛获奖或业内认可的经历？
...
1. **Summary 放最上面** —— 让老板一眼就能看到最关键的 insights。
    
2. **逻辑清晰地拆解模糊问题** —— 告诉老板你是怎么推导出结论的。
    
3. **数据支持决策** —— 用数据，而不是“我觉得”来说服老板。
...
> **Summary:**  
> 我们基于强化学习项目经验、代码质量、论文贡献三个维度，对 10 名候选人进行了评分，得分最高的是 C（总分 13 分），建议优先考虑。
